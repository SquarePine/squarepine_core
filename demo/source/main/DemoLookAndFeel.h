...
public:
    ...
    void applyTo (LookAndFeel_V4& lookAndFeel) override
    {
        ...
        lookAndFeel.setColour (TextButton::buttonColourId,          darkTheme::secondary);
        lookAndFeel.setColour (TextButton::buttonOnColourId,        darkTheme::secondary.brighter (0.8f));
        lookAndFeel.setColour (TextButton::textColourOffId,         darkTheme::onSecondary);
        lookAndFeel.setColour (TextButton::textColourOnId,          darkTheme::onSecondary);
