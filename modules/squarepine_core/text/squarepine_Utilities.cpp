namespace details
{
    ...
    */
    ...
    inline String toConvertedCase (const String& source, Func func)
    {
        ...
        String result;
        result.preallocateBytes (source.getNumBytesAsUTF8()); // At least it'll allocate "some" and not "none."
...
juce_wchar toUpperCase (juce_wchar character) noexcept  { return details::toUpperCase (character); }
juce_wchar toLowerCase (juce_wchar character) noexcept  { return details::toLowerCase (character); }
bool isUpperCase (juce_wchar character) noexcept        { return toLowerCase (character) != character; }
bool isLowerCase (juce_wchar character) noexcept        { return details::caseConversionMap.find (character) != std::cend (details::caseConversionMap); }
String toUpperCase (const String& source)               { return details::toConvertedCase (source, details::toUpperCase); }
String toLowerCase (const String& source)               { return details::toConvertedCase (source, details::toLowerCase); }
