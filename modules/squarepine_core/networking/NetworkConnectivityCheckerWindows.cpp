...
namespace
{
    ...
    */
    ...
    double getCurrentSystemRSSI()
    {
        ...
        if (WlanScan (clientHandle, &interfaceInfo->InterfaceGuid, &connectionAttributes->wlanAssociationAttributes.dot11Ssid, nullptr, nullptr) != ERROR_SUCCESS)
        {
            return 0.0;
        }
        ...
        if (WlanGetNetworkBssList (clientHandle, &interfaceInfo->InterfaceGuid, &connectionAttributes->wlanAssociationAttributes.dot11Ssid,
