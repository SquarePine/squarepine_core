/** Threefish encryption class.

    @see https://en.wikipedia.org/wiki/Threefish

    @see https://github.com/QRCS-CORP/CEX/blob/master/CEX/Threefish.h
    @see https://github.com/QRCS-CORP/CEX/blob/master/CEX/ThreefishModes.h


*/
class Threefish final
{
public:
    //==============================================================================
    ...
    */
    Threefish (const void* keyData, int keyBytes);

    /** Creates a copy of another Threefish object. */
    Threefish (const Threefish&);

    /** Copies another Threefish object. */
    Threefish& operator= (const Threefish&) noexcept;
...
private:
    ...
    bool apply (void*, size_t, void (Threefish::*op) (uint32&, uint32&) const) const;
    uint32 F (uint32) const noexcept;

    //==============================================================================
    JUCE_LEAK_DETECTOR (Threefish)
};
