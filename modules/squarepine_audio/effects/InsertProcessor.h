                        ...
                        public AudioProcessorParameter::Listener
{
    struct ParameterCallback
    {
        ...
        ParameterCallback (int parameterIndex, AudioProcessorParameter* rawParameter, std::function<void (float&)> parameterCallback): index (parameterIndex),
...
public:
    ...
    public:
        ...
        void addParameterToLink(RangedAudioParameter* param)
        {
            ...
            if(it == linkedParams.end()) linkedParams.push_back(param);
        }
        ...
        bool contains(RangedAudioParameter* param)
        {
            ...
            auto it = std::find(linkedParams.begin(),linkedParams.end(),param);
            if(it!= linkedParams.end())return true;
            
            if(param == primaryParam)return true;
