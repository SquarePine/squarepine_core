/** */
class SimpleNoiseGateProcessor final : public InternalProcessor
{
public:
    /** Constructor. */
    SimpleNoiseGateProcessor();
    ...
    //==============================================================================
    /** @internal */
    const String getName() const override { return NEEDS_TRANS ("Simple Noise Gate"); }
    /** @internal */
    Identifier getIdentifier() const override { return "noiseGate"; }
    /** @internal */
...
private:
    //==============================================================================
    dsp::NoiseGate<float> floatNoiseGate;
    dsp::NoiseGate<double> doubleNoiseGate;
    ...
    void process (juce::AudioBuffer<FloatType>&, dsp::NoiseGate<FloatType>&);

    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SimpleNoiseGateProcessor)
};
