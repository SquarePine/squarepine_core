PhaserProcessor::PhaserProcessor (int idNum): idNumber (idNum)
{
    ...
    NormalisableRange<float> otherRange = { 0.f, 10 };
...
//============================================================================== Audio processing
void PhaserProcessor::prepareToPlay (double, int)
{
}
void PhaserProcessor::processBlock (juce::AudioBuffer<float>&, MidiBuffer&)
{
}

const String PhaserProcessor::getName() const { return TRANS ("PhaserProcessor"); }
/** @internal */
Identifier PhaserProcessor::getIdentifier() const { return "PhaserProcessor" + String (idNumber); }
/** @internal */
bool PhaserProcessor::supportsDoublePrecisionProcessing() const { return false; }
//============================================================================== Parameter callbacks
void PhaserProcessor::parameterValueChanged (int, float)
{
