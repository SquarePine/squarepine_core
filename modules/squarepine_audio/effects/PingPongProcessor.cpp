...
void PingPongProcessor::processBlock (juce::AudioBuffer<float>&, MidiBuffer&)
{
}

const String PingPongProcessor::getName() const { return TRANS ("PingPongProcessor"); }
/** @internal */
Identifier PingPongProcessor::getIdentifier() const { return "PingPongProcessor" + String (idNumber); }
/** @internal */
bool PingPongProcessor::supportsDoublePrecisionProcessing() const { return false; }
//============================================================================== Parameter callbacks
void PingPongProcessor::parameterValueChanged (int, float)
{
