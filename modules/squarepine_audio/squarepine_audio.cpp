...
namespace sp
{
    ...
    #include "effects/SimpleChorusProcessor.cpp"
    #include "effects/SimpleCompressorProcessor.cpp"
    #include "effects/SimpleDistortionProcessor.cpp"
    #include "effects/SimpleEQProcessor.cpp"
    #include "effects/SimpleLimiterProcessor.cpp"
    #include "effects/SimpleNoiseGateProcessor.cpp"
    #include "effects/SimplePhaserProcessor.cpp"
    #include "effects/SimpleReverbProcessor.cpp"
